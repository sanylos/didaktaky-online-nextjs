    ...
    return (
        <div className="d-flex flex-column main">
            <div className='p-1 shadow-lg mb-2'>
                <h1 className='mb-0 fw-bold text-learn-1'>Elektronická učebnice</h1>
                <h5 className='text-learn-4'>Hledáte komplexní přípravu na maturitní a přijímací zkoušky z češtiny, angličtiny a matematiky? Pak jste na správném místě! Nabízíme rozsáhlou sbírku materiálů, učebních osnov a témat, která vám pomohou dosáhnout vašich cílů.</h5>
            </div>
            <div className='p-1'>
                {pros.map((item, index) => (
